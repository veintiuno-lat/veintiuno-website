...
export const cards: Card[] = [
  ...
  {
    id: "4",
    communityId: "satoshi-somos-todos",
  ...
  {
    id: "6",
    communityId: "escuelita-bitcoin",
    communityName: "Escuelita Bitcoin",
    location: "Paraguay y Montevideo, Uruguay ",
    artist: "leonelzab",
    number: "6/40",
  ...
  {
    id: "13",
    communityId: "prospera-distrito-bitcoin",
  ...
  {
    id: "15",
    communityId: "bitcoin-berlin",
    communityName: "Bitcoin Berlín",
    location: "Berlín, Usulutan, El Salvador",
    artist: "josediosok",
    number: "15/40",
