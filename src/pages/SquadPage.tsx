...
const SquadPage: React.FC = () => {
  ...
  const getCommunitiesByIds = (communityIds: string[]) => {
    return communities.filter(community => communityIds.includes(community.id));
  };

  const assignedCommunities = squad.communities ? getCommunitiesByIds(squad.communities) : [];
  ...
  const squadDetails = {
    ...
    whyBtc: "A Bitcoin Community Project in Isla Mujeres, Mexico. The future of money is here — and it's orange.",
    cards: [
    ...
    artists: [
      { name: "@altafacha69", cards: "5/5 Tarjetas", avatar: "/images/artists-images/avatar-altafacha.png" },
      { name: "@abstractlai", cards: "3/3 Tarjetas", avatar: "/images/artists-images/avatar-abstractlai.png" },
      { name: "@elsyluque54", cards: "2/2 Tarjetas", avatar: "/images/artists-images/avatar-elsyluque54.png" }
    ]
  };
  ...
  return (
    <>
      <SEOHead
        ...
        keywords={[squad.name, "squad", "ejército", "veintiuno", "bitcoin", "comunidad"]}
        url={`/squad/${squad.id}`}
        type="website"
      />
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        parent.className = parent.className.replace('overflow-hidden', '') + ' bg-gradient-to-br from-bitcoin to-yellow-500 flex items-center justify-center';
                        parent.innerHTML = `<span class="text-white font-bold text-2xl">${squad.name.split(' ').map(word => word[0]).join('')}</span>`;
                      }
                    }}
                  />
                </div>
              ...
              <div className="flex-1">
                ...
                <div>
                  ...
                  <div className="flex items-center mt-2">
                    ...
                    <span className="text-sm text-gray-600 font-body">Innovation in action</span>
                  </div>
                </div>
              </div>
                            ...
                            <div className="w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
                              <img
                                ...
                                onError={(e) => {
                                  ...
                                  if (parent) {
                                    parent.className = parent.className.replace('overflow-hidden', '') + ' bg-gradient-to-br from-bitcoin to-yellow-500 flex items-center justify-center';
                                    parent.innerHTML = `<span class="text-white font-bold text-sm">${member.username.charAt(1).toUpperCase()}</span>`;
                                  }
                                }}
                              />
                            </div>
            ...
            <div className="flex justify-center">
              ...
              >
                {squadDetails.cards.map((card) => (
                  <UICard key={card.id} className="border border-[#D9D9D9] overflow-hidden">
                    <CardContent className="p-0">
                      <img
                        src={card.image}
                        alt={card.title}
                        ...
                        >
                          <img
                            ...
                            onError={(e) => {
                              ...
                              if (parent) {
                                parent.className = parent.className.replace('overflow-hidden', '') + ' bg-gradient-to-br from-bitcoin to-yellow-500 flex items-center justify-center';
                                parent.innerHTML = `<span class="text-white font-bold text-sm">${artist.name.charAt(1).toUpperCase()}</span>`;
                              }
                            }}
                          />
                        </div>
