...
import { ChevronLeft, ExternalLink, MapPin, Users, Mail, Instagram, Youtube, Clock } from "lucide-react";
...
const CommunityPage: React.FC = () => {
  ...
  const supportingSquad = community.squadId ? squads.find(squad => squad.id === community.squadId) : null;
  ...
  const communityMeetups = meetups.filter(meetup => 
    meetup.organizerCommunity?.id === community.id
  ...
  return (
    <>
      <SEOHead
        ...
        description={`Conoce a ${community.title}, una comunidad Bitcoin en ${community.city || 'ciudad'}, ${community.country}. ${community.description}`}
        keywords={[community.title, "comunidad bitcoin", "bitcoin", community.country.toLowerCase(), (community.city || 'ciudad').toLowerCase()]}
      ...
      <div className="min-h-screen bg-white">
        {/* Hero Section */}
        <section 
          className="py-24 bg-custom-black text-white relative overflow-hidden"
        >
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        parent.className = parent.className.replace('overflow-hidden', '') + ' bg-gradient-to-br from-bitcoin to-yellow-500 flex items-center justify-center';
                        parent.innerHTML = `<span class="text-white font-bold text-2xl">${community.title.split(' ').map(word => word[0]).join('')}</span>`;
                      }
                    }}
                  />
                </div>
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <div className="space-y-3 mb-8">
                  ...
                  <div className="flex items-center space-x-2 text-white">
                    <Users className="w-5 h-5" />
                    <span className="font-body">Alrededor de 150 bitcoiners</span>
                  </div>
                  <div className="flex items-center space-x-2 text-white">
                    <MapPin className="w-5 h-5" />
                    <span className="font-body">{community.city || 'Ciudad'}, {community.country}</span>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button 
                    className="bg-bitcoin hover:bg-bitcoin text-white"
                    onClick={() => window.open(`mailto:contact@${community.id}.com`, '_blank')}
                  >
                    E-mail
                  ...
                  <Button 
                    ...
                    onClick={() => window.open(`https://x.com/${community.id}`, '_blank')}
                  >
                    {community.title} X
                    <ExternalLink className="ml-2 h-4 w-4" />
                  </Button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="space-y-6 text-lg text-gray-700 font-body leading-relaxed">
                  ...
                  <p>
                    Our goal is to build <strong>{community.title}: a movement to create a thriving Bitcoin circular economy</strong> in {community.city || 'our city'}.
                  </p>
                    ...
                    <UICard className="border">
                      <CardContent className="p-6">
                        <div className="flex items-center space-x-4">
                          ...
                          />
                          <div>
                            <h3 className="font-bold text-gray-900 text-lg">{supportingSquad.name}</h3>
                            <div className="flex items-center space-x-1 text-gray-600">
                              <Users className="w-4 h-4" />
                              <span className="text-sm">{supportingSquad.soldiers} Soldiers</span>
                            </div>
                          </div>
                        </div>
                      </CardContent>
                ...
                <div>
                  ...
                  <UICard className="border border-[#D9D9D9]">
                    <CardContent className="p-6 space-y-4">
                      <div>
                        <span className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Días</span>
                        <p className="text-lg font-body">Miércoles, quincenal</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-lg font-body">Big Street Name, Name of the Place, {community.city || 'Ciudad'} - {community.country}</p>
                      </div>
                      <div>
                        <span className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Redes Sociales</span>
          ...
          <div className="px-6">
            ...
            {communityMeetups.length > 0 ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-500 text-lg font-body">No hay eventos próximos programados para esta comunidad.</p>
              </div>
            )}
          </div>
        </section>
              ...
              <UICard className="max-w-2xl">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-gray-700 mb-6 font-body">
                    Si conoces una comunidad Bitcoin ONLY que debería estar aquí, compártela con nosotros.
                  </p>
